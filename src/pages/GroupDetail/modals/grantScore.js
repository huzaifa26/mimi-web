import { Grid, Input, makeStyles, TextField, Typography, CircularProgress, Divider, Box } from '@material-ui/core';
    ...
    return (
        <Fragment>
            <Field label={<FormattedMessage id="topic_name" />}>
                <Input className={classes.input} value={topicName} onChange={e => setTopicName(e.target.value)} />
            </Field>
