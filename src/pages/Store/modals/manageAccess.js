...
import { getSectionHeaderStyles, getModalStyles, getTypographyStyles, FirebaseHelpers, getPageStyles, searchBy } from '../../../utils/helpers';
...
export const ManageAccessBody = props => {
    ...
    useEffect(() => {
        ...
        const selectedKidIds = store.access;
    ...
    const handleSubmit = async () => {
        try {
            ...
            const _removeKids = differenceWith(store.access, _selectedKids, (a, b) => a === b);
            const _removeGroups = differenceWith(store.group_access, _selectedGroups, (a, b) => a === b);
